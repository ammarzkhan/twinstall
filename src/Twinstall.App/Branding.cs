...
{
    /// <summary>
    /// Twinstall's own mark, loaded from the embedded icon.
    ///
    ...
    ///
    /// Note the asymmetry with <see cref="Twinstall.Platform.LogoExtractor"/>, and that it is
    ...
    {
        private const string ResourceName = "Twinstall.App.logo.ico";
