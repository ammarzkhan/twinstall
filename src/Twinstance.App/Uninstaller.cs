...
{
    /// <summary>
    /// Removes Twinstance, as invoked from Settings → Apps → Installed apps.
    ///
    ...
    /// Twinstance in the first place, and an uninstaller that silently logs someone out of two
    ...
    internal static class Uninstaller
    {
        internal static int Run()
        {
            ...
            var what = new StringBuilder("Remove Twinstance?\r\n\r\nThis will delete:\r\n\r\n");
            ...
            if (Registration.IsOurProgramFolder(Path.GetDirectoryName(AppPaths.SelfExe)))
                what.Append("  •  the Twinstance program folder itself\r\n");
            ...
            // themselves long before Twinstance existed, and reverting it would change how every
            ...
            var done = new StringBuilder("Twinstance has been removed.\r\n\r\n");
            ...
            if (Registration.ScheduleSelfDelete())
                ...
                done.Append("Twinstance was run from ")
