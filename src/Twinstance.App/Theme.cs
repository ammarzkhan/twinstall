...
namespace Twinstance.App
{
    ...
    {
        // Chrome, not observation, so it lives with the UI rather than in Twinstance.Platform.
        ...
        /// <summary>
        /// Twinstance's own colour, deliberately not the Windows accent and deliberately not
        /// anyone else's brand.
        ///
