...
namespace Twinstance.App
{
    ...
    internal sealed class InstanceDialog : Form
    {
        ...
        ///
        /// Cyan used to be in here and was removed: it sat close enough to Twinstance's own teal
        ...
        /// keeps it, and Twinstance's folder holds nothing it did not create.
        /// </summary>
        ...
        {
            if (!Ui.Confirm("Remove the “" + (existing?.Name ?? _name.Text) + "” account from Twinstance?\r\n\r\n"
