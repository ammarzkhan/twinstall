...
namespace Twinstance.App
{
    ...
    ///
    /// It exists because "open Settings and pick Twinstance" is not an instruction a newcomer
    ...
    internal sealed class SettingsHint : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            y = Row(g, y, "1", "Under " + Scheme.ToUpperInvariant() + ", click “Choose a default”.",
                    null, DrawChooseRow);
            Row(g, y, "2", "Pick Twinstance, then choose Set default.", null, DrawPickRow);
        }
        ...
        private void DrawPickRow(Graphics g, Rectangle r)
        {
            ...
            TextRenderer.DrawText(g, "Twinstance", Theme.BodyStrong,
