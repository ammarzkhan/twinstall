...
static class Tests
{
    ...
    static void LaunchProbeTests()
    {
        ...
        Eq(dir, @"C:\Users\a\AppData\Local\Temp\Twinstance\probe-abc123", "probe directory derived");
        ...
        const string spaced = @"C:\Users\Alex Taylor\AppData\Local\Temp\Twinstance\probe-x";
    ...
    static void ProfileDiscoveryTests()
    {
        ...
        // Claude: its own root, holding the original profile and a Twinstance second instance.
